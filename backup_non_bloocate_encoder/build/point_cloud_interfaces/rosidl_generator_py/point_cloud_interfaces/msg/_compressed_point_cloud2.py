...
class Metaclass_CompressedPointCloud2(type):
    """Metaclass of message 'CompressedPointCloud2'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('point_cloud_interfaces')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__compressed_point_cloud2
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__compressed_point_cloud2
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__compressed_point_cloud2
            cls._TYPE_SUPPORT = module.type_support_msg__msg__compressed_point_cloud2
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__compressed_point_cloud2
...
class CompressedPointCloud2(metaclass=Metaclass_CompressedPointCloud2):
    """Message class 'CompressedPointCloud2'."""
