...
bool point_cloud_interfaces__msg__compressed_point_cloud2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("point_cloud_interfaces.msg._compressed_point_cloud2.CompressedPointCloud2", full_classname_dest, 73) == 0);
  }
  point_cloud_interfaces__msg__CompressedPointCloud2 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CompressedPointCloud2 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("point_cloud_interfaces.msg._compressed_point_cloud2");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CompressedPointCloud2");
