...
#include "point_cloud_interfaces/msg/detail/compressed_point_cloud2__rosidl_typesupport_fastrtps_c.h"
...
#include "point_cloud_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_point_cloud_interfaces
...
using _CompressedPointCloud2__ros_msg_type = point_cloud_interfaces__msg__CompressedPointCloud2;

static bool _CompressedPointCloud2__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CompressedPointCloud2__ros_msg_type * ros_message = static_cast<const _CompressedPointCloud2__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _CompressedPointCloud2__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _CompressedPointCloud2__ros_msg_type * ros_message = static_cast<_CompressedPointCloud2__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_point_cloud_interfaces
size_t get_serialized_size_point_cloud_interfaces__msg__CompressedPointCloud2(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CompressedPointCloud2__ros_msg_type * ros_message = static_cast<const _CompressedPointCloud2__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CompressedPointCloud2__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_point_cloud_interfaces__msg__CompressedPointCloud2(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_point_cloud_interfaces
size_t max_serialized_size_point_cloud_interfaces__msg__CompressedPointCloud2(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = point_cloud_interfaces__msg__CompressedPointCloud2;
    is_plain =
      (
...
static size_t _CompressedPointCloud2__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_point_cloud_interfaces__msg__CompressedPointCloud2(
...
static message_type_support_callbacks_t __callbacks_CompressedPointCloud2 = {
  "point_cloud_interfaces::msg",
  "CompressedPointCloud2",
  _CompressedPointCloud2__cdr_serialize,
  _CompressedPointCloud2__cdr_deserialize,
  _CompressedPointCloud2__get_serialized_size,
  _CompressedPointCloud2__max_serialized_size
};

static rosidl_message_type_support_t _CompressedPointCloud2__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CompressedPointCloud2,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, point_cloud_interfaces, msg, CompressedPointCloud2)() {
  return &_CompressedPointCloud2__type_support;
}
